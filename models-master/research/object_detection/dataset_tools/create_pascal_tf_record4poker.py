...
flags = tf.app.flags
flags.DEFINE_string('data_dir', 'G:/PycharmProjects/models-master/dataset/images', 'Root directory to raw PASCAL VOC dataset.')
flags.DEFINE_string('set', 'G:/PycharmProjects/models-master/dataset/qqPoker/val.txt', 'Convert training set, validation set or '
                                    'merged set.')
flags.DEFINE_string('annotations_dir', 'G:/PycharmProjects/models-master/dataset/annotations',
                    '(Relative) path to annotations directory.')
flags.DEFINE_string('year', 'VOC2007', 'Desired challenge year.')
flags.DEFINE_string('output_path', 'G:/PycharmProjects/models-master/dataset/qqPoker/val.record', 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', 'G:/PycharmProjects/models-master/dataset/poker_label_map.pbtxt',
